#ifndef JAVA_CLASSFILE_PARSER_INTERNAL_ONSTACK_CONSTANT_NAMEANDTYPE_INFO_H
#define JAVA_CLASSFILE_PARSER_INTERNAL_ONSTACK_CONSTANT_NAMEANDTYPE_INFO_H
...
#define __JAVA_CLASSFILE_PARSER_CONSTANT_NameAndType_info_freev(scope, p) do { \
  } while (0)
...
#define _JAVA_CLASSFILE_PARSER_CONSTANT_NameAndType_info_validateb(scope, classfilep, p) do { \
  } while (0)

#endif /* JAVA_CLASSFILE_PARSER_INTERNAL_ONSTACK_CONSTANT_NAMEANDTYPE_INFO_H */
