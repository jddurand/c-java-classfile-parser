#ifndef JAVA_CLASSFILE_PARSER_INTERNAL_ONSTACK_CONSTANT_FIELDREF_INFO_H
#define JAVA_CLASSFILE_PARSER_INTERNAL_ONSTACK_CONSTANT_FIELDREF_INFO_H
...
#define __JAVA_CLASSFILE_PARSER_CONSTANT_Fieldref_info_freev(scope, p) do { \
  } while (0)
...
#define _JAVA_CLASSFILE_PARSER_CONSTANT_Fieldref_info_validateb(scope, loaderp, p) do { \
  } while (0)
