...
#define _JAVA_CLASSFILE_PARSER_U2_BE(scope, type, onstack, u2, bufferp, lengthl) do { \
    if (lengthl >= 2) {                                                 \
...
#define _JAVA_CLASSFILE_PARSER_U2_LE(scope, type, onstack, u2, bufferp, lengthl) do { \
    if (lengthl >= 2) {                                                 \
